    ...
    >
      ...
      <form>
        <input
          ...
          className="mb-2 w-full rounded-md border border-body-color border-opacity-10 py-3 px-6 text-base font-medium text-body-color placeholder-body-color outline-none focus:border-primary focus:border-opacity-100 focus-visible:shadow-none dark:border-white dark:border-opacity-10 dark:bg-[#242B51] focus:dark:border-opacity-50"
        />
        <input
          type="email"
          name="email"
        ...
        <p className="text-center text-base font-medium leading-relaxed text-body-color">
          Nous ne partageons pas vos données. Désabonnez-vous à tout moment.
        </p>
      </form>
